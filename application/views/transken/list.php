...
<div class="modal fade" id="formModal">
    <div class="modal-dialog">
      ...
      <div class="modal-body">
        <form action="<?= base_url('trans_ken/simpan')?>" method="post" id="form">
            <div class="form-group">
                ...
                <?php
                  foreach ($kendaraan->result() as $row){
                    echo "<option value=".$row->id_kendaraan.">".$row->merk."</option>";
                  }
                ?>
                </select>
                </div>
...
<!--/Modal tambah-->
<!-- Modal Edit -->
<?php $no=0; foreach($transaksi_ken as $row): $no++; ?>
  <div id="modal-edit<?=$row->id_trans_ken;?>" class="modal fade">
    <div class="modal-dialog">
    <form action="<?= base_url('trans_ken/edit')?>" method="post" id="form">
        <div class="modal-content">
            <div class="modal-header bg-primary">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
    ...
    <div class="modal-body">
        <input type="hidden" readonly value="<?=$row->id_trans_ken;?>" name="id_trans_ken" class="form-control" >
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-7">
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <h3 class="box-title">Transaksi Kendaraan</h3>
        </div>
      <!-- /.box-header -->
    <div class="box-body">
      ...
      <div class="row">
        ...
        <?php
            ...
            <tr>
              ...
              <a data-toggle="modal" data-target="#modal-edit<?=$row->id_trans_ken;?>" data-popup="tooltip" data-placement="top" class="btn btn-success btn-sm tooltip-demo btn-xs" title="Edit"><i class="fa fa-pencil"></i></a>
              <a href="<?= base_url(); ?>trans_ken/selesai/<?= $row->id_trans_ken; ?>" class="btn btn-primary btn-sm tooltip-demo btn-xs" title="Edit"><i class=""></i>Pengembalian</a>
              </td>
              </tr>
            <?php $no++;}?>
        </tbody>
