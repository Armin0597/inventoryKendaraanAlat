    ...
    <div class="modal-dialog">
      ...
      <?= form_open_multipart('jenis_ken/simpan');?>
...
<!-- ModalEdit -->
<!-- Modal Edit -->
<?php $no=0; foreach($jenis_ken as $row): $no++; ?>
<div class="row">
  <div id="modal-edit<?=$row->id_jenis_ken;?>" class="modal fade">
    <div class="modal-dialog">
    <?= form_open_multipart('jenis_ken/edit');?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <input type="hidden" readonly value="<?=$row->id_jenis_ken;?>" name="id_jenis_ken" class="form-control" >
          <div class="form-group">
  ...
  <section class="content">
    ...
    <thead>
        ...
        <tr>
          ...
          <a data-toggle="modal" data-target="#modal-edit<?=$row->id_jenis_ken;?>" data-popup="tooltip" data-placement="top" class="btn btn-success btn-sm tooltip-demo btn-xs" title="Edit"><i class="fa fa-pencil"></i></a>
          <a href="<?= base_url(); ?>jenis_ken/hapus/<?= $row->id_jenis_ken; ?>" class="btn btn-danger btn-sm float-right tombol-hapus btn-xs" title="Hapus"><i class="fa fa-trash"></i></a>
          </td>
        </tr>
          <?php $no++;}?>
